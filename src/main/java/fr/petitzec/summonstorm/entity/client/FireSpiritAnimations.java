...
public class FireSpiritAnimations {
    public static final AnimationDefinition ANIM_FIRE_SPIRIT_IDLE = AnimationDefinition.Builder.withLength(2f).looping()
            .addAnimation("tail",
    ...
    public static final AnimationDefinition ANIM_FIRE_SPIRIT_WALKING = AnimationDefinition.Builder.withLength(4f).looping()
            .addAnimation("body",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            new Keyframe(0f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("handR",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            ...
                            new Keyframe(4f, KeyframeAnimations.degreeVec(-15f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR))).build();
    public static final AnimationDefinition ANIM_FIRE_SPIRIT_ATTACK = AnimationDefinition.Builder.withLength(2f).looping()
            .addAnimation("tail",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            new Keyframe(0f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
